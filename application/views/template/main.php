...
<head>
    ...
    <!-- sweetalert2 -->
    <link href="<?= base_url() ?>assets/assets/plugins/node_modules/sweetalert2/dist/sweetalert2.min.css" rel="stylesheet" type="text/css">

    <!-- fontawesome 5 -->
    <link href="<?= base_url() ?>assets/assets/plugins/fontawesome-free-5/css/fontawesome.min.css" rel="stylesheet" type="text/css">


    <script src="<?= base_url() ?>assets/assets/js/jquery.min.js"></script>

    <!-- Sweet-Alert  -->
    <script src="<?= base_url() ?>assets/assets/plugins/node_modules/sweetalert2/dist/sweetalert2.all.min.js"></script>
...
<body>
        ...
        <div class="topbar-main">
            <div class="container-fluid">
                ...
                <div class="logo">
                    ...
                    <!-- Image Logo -->
                    <a href="index.html" class="logo">
                        <img src="<?= base_url() ?>assets/assets/images/logo-sm.png" alt="" height="22" class="logo-small">
                        <img src="<?= base_url() ?>assets/assets/images/logo.png" alt="" height="16" class="logo-large">
                    </a>
                ...
                <div id="navigation">
                    ...
                    <ul class="navigation-menu">
                        ...
                        <li class="has-submenu">
                            <a href="<?= site_url('home') ?>"><i class="mdi mdi-airplay"></i>Dashboard</a>
                        </li>

                        <li class="has-submenu">
                            <a href="<?= site_url('mahasiswa') ?>"><i class="fa fa-users"></i>Mahasiswa</a>
                        </li>
    ...
    <!-- fontawesome 5 -->
    <script src="<?= base_url() ?>assets\assets\plugins\fontawesome-free-5\js\fontawesome.min.js"></script>
