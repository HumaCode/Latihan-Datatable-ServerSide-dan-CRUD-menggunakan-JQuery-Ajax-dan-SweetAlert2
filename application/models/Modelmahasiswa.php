...
class Modelmahasiswa extends CI_Model
{
    ...
    var $column_order = array(null, 'nobp', 'nama', 'tmplahir', 'tgllahir', 'jenkel', null); //Sesuaikan dengan field
    var $column_search = array('nobp', 'nama'); //field yang diizin untuk pencarian 
    ...
    public function simpan($nobp, $nama, $tmplahir, $tgllahir, $jenkel)
    {
        // simpan data
        $simpan = [
            'nobp' => $nobp,
    ...
    public function ambildataById($nobp)
    {
        return $this->db->get_where('mahasiswa', ['nobp' => $nobp]);
    }

    public function update($nobp, $nama, $tmplahir, $tgllahir, $jenkel)
    {
        // simpan data
        $update = [
            'nama' => $nama,
